...
const validEmail = (val) => /^[A-Z0-9.%+-]+@[A-Z0-9.-]+\.com$/i.test(val);
                    ...
                    <Row className="form-group">
                      ...
                      <Col md={10}>
                        <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Tel. number"
                          className="form-control" validators={{
                            required, minLength: minLength(7), maxLength: maxLength(13), isNumber
                          }} />
                        <Errors className="text-danger" model=".telnum" show="touched" messages={{
                              required:"Required ",
                              minLength: "Must be greater than 7 numbers",
                              maxLength: "Must be less than 13 numbers or less",
